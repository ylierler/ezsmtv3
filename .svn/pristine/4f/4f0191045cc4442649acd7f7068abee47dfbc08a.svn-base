...
bool CDatabase::enlarge_lit_pool(void) {
  ...
  //line (i) LINE MUST BE UNCOMMENTED FOR 64 bit archetecture
  //and line (ii) COMMENTED
  //  long long displacement = _lit_pool_start - old_start;//(i)
  //  int displacement = _lit_pool_start - old_start;//(ii)
